...
def create_app():
    ...
    app.config['SECRET_KEY'] = 'ivyzeng' # it is used by Flask and extensions to keep data safe
    # app.config['SQLALCHEMY_DATABASE_URI'] = "postgres://postgres:ivyzeng@localhost:5432/gym_membership"
